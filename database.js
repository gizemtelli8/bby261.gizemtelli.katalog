var catalog = [
    ...
    }, 
	{
        ...
        "itemImage":"kapak/fil.jpg",
        "itemCreationDate":"2015",
        "itemDescription":"<p>Kollarını boynuma dolayıp bana sarılıyor ve başını omzuma yaslıyor. Ama mesele şu: Az önce ona söylediklerim, bütün gün ara ara düşündüklerim, şey, bir tür görünmez çizgiyi aşmışım gibi hissediyorum. Hiç gelmek zorunda kalmayacağımı sandığım bir yere gelmişim gibi hissediyorum. Ve buraya nasıl geldiğimi bilmiyorum. Garip bir yer. Kısa, zararsız bir rüyanın, sonra da sabah erkenden yapılan uykulu bir konuşmanın beni ölüm ve yok oluş düşüncelerine sürüklediği bir yer.Yaşamın acı yüzüyle bu kadar erken tanışmasaydı, kuşkusuz yine yazar olurdu ama hiçbir zaman okurları tarafından böyle sahiplenilmezdi Raymond Carver. Gençlerin haytalık yapıp havai aşklar kovaladığı yaşlarda o evli ve iki çocuk babasıydı. Hayatı öğrenmenin yolu, bulduğu her işte çalışmaktı. Benzincide çalıştı, hademelik, garsonluk yaptı. Yaşananlar, kâğıda döküldüğünde bazen Çehov tadındaydı, bazen Kafka... İnsanların yaşamlarında barınan, gizlenen öyküleri, yalın, gerçekçi, acıtan şiirsel bir dille yansıttı. Yenilenler içkiye sığınırken, kısa öykü türünü yeniden var eden Carver, her başarısında içti, çok içti, ölümüne içti...Raymond Carver'ın son dönem öykülerini içeren Fil, yazarın en önemli eserlerinden biri olarak görülüyor.</p>"
    },
    {
        "itemName":"Uçan Sınıf",
        "itemAuthor":"Erich Kastner",
        "itemImage":"kapak/ucansinif.jpg",
        "itemCreationDate":"2015",
        "itemDescription":"<p>Erich Kastner, çocuklar için de, büyükler için de yazan Almanya'nın ünlü yazarlarından biri.Uçan Sınıf'ın kahramanları, yatılı bir okulun çocukları. Yılbaşına az bir zaman kalmıştır. Çocuklar, Uçan Sınıf adında bir oyun hazırlamaya karar verirler. Ne var ki çalışmaları yarım kalır. Çünkü bir başka okulun öğrencileri, hem oyunda rol alan oyunculardan birini, hem de çocukların alıştırma kitaplarını kaçırmışlardır. Kastner'in 'Yazdığım en iyi kitap' dediği Uçan Sınıf, ince bir hüzün ve bolca mizahla kaleme alınmış bir başyapıt. Bu kitapta yazar, çocuklar arasındaki dayanışmanın, sıkı bir arkadaşlığın gücüyle yaşamın zorluklarını alt etmenin güzel bir örneğini veriyor.</p>"
    },
